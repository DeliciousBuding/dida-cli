...
func didaCommandSchemas() []commandSchema {
	return []commandSchema{
		...
		{ID: "project.tasks", Title: "List tasks in a project", Resource: "project", Operation: "read", Command: "dida project tasks <project-id> --compact --json", HTTP: []string{"GET /project/{projectId}/tasks"}, Status: "stable", AuthRequired: true, Compact: true},
