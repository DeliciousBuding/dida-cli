...
func didaCommandSchemas() []commandSchema {
	return []commandSchema{
		...
		{ID: "openapi.doctor", Title: "Check official OAuth OpenAPI setup", Resource: "openapi", Operation: "read", Command: "dida openapi doctor --json", HTTP: []string{"GET/POST oauth metadata only"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_OPENAPI_CLIENT_ID and DIDA365_OPENAPI_CLIENT_SECRET in the environment."},
