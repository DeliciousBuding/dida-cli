...
func didaCommandSchemas() []commandSchema {
	schemas := []commandSchema{
		...
		{ID: "official.project.list", Title: "List projects through official MCP", Resource: "official-project", Operation: "read", Command: "dida official project list --json", HTTP: []string{"POST https://mcp.dida365.com tools/call list_projects"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.project.get", Title: "Read one project through official MCP", Resource: "official-project", Operation: "read", Command: "dida official project get <project-id> --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_project_by_id"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.project.data", Title: "Read project and undone tasks through official MCP", Resource: "official-project", Operation: "read", Command: "dida official project data <project-id> --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_project_with_undone_tasks"}, Status: "stable", AuthRequired: false, Compact: true, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.task.get", Title: "Read one task through official MCP", Resource: "official-task", Operation: "read", Command: "dida official task get <task-id> --project <project-id> --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_task_by_id", "POST https://mcp.dida365.com tools/call get_task_in_project when --project is set"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.task.search", Title: "Search tasks through official MCP", Resource: "official-task", Operation: "read", Command: "dida official task search --query <text> --json", HTTP: []string{"POST https://mcp.dida365.com tools/call search_task"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.task.query", Title: "List undone tasks through official MCP time query", Resource: "official-task", Operation: "read", Command: "dida official task query --query today --json", HTTP: []string{"POST https://mcp.dida365.com tools/call list_undone_tasks_by_time_query"}, Status: "stable", AuthRequired: false, Compact: true, Notes: "Requires DIDA365_TOKEN in the environment. Sends the query as query_command to the upstream MCP tool."},
		...
		{ID: "official.task.batchAdd", Title: "Batch add tasks through official MCP", Resource: "official-task", Operation: "write", Command: "dida official task batch-add --args-json '{...}' --dry-run --json", HTTP: []string{"POST https://mcp.dida365.com tools/call batch_add_tasks"}, Status: "stable", AuthRequired: false, DryRun: true, Notes: "Requires DIDA365_TOKEN unless --dry-run is used. Payload follows the upstream MCP tool schema."},
		{ID: "official.task.batchUpdate", Title: "Batch update tasks through official MCP", Resource: "official-task", Operation: "write", Command: "dida official task batch-update --args-json '{...}' --dry-run --json", HTTP: []string{"POST https://mcp.dida365.com tools/call batch_update_tasks"}, Status: "stable", AuthRequired: false, DryRun: true, Notes: "Requires DIDA365_TOKEN unless --dry-run is used. Payload follows the upstream MCP tool schema."},
		{ID: "official.task.completeProject", Title: "Complete tasks in one project through official MCP", Resource: "official-task", Operation: "write", Command: "dida official task complete-project --project <project-id> --task <task-id> --dry-run --json", HTTP: []string{"POST https://mcp.dida365.com tools/call complete_tasks_in_project"}, Status: "stable", AuthRequired: false, DryRun: true, Notes: "Requires DIDA365_TOKEN unless --dry-run is used. Supports repeated --task or comma-separated --tasks."},
		{ID: "official.habit.list", Title: "List habits through official MCP", Resource: "official-habit", Operation: "read", Command: "dida official habit list --json", HTTP: []string{"POST https://mcp.dida365.com tools/call list_habits"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.habit.sections", Title: "List habit sections through official MCP", Resource: "official-habit", Operation: "read", Command: "dida official habit sections --json", HTTP: []string{"POST https://mcp.dida365.com tools/call list_habit_sections"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.habit.get", Title: "Read one habit through official MCP", Resource: "official-habit", Operation: "read", Command: "dida official habit get <habit-id> --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_habit"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.habit.create", Title: "Create habit through official MCP", Resource: "official-habit", Operation: "write", Command: "dida official habit create --args-json '{...}' --json", HTTP: []string{"POST https://mcp.dida365.com tools/call create_habit"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment. Payload follows the official MCP tool schema."},
		{ID: "official.habit.update", Title: "Update habit through official MCP", Resource: "official-habit", Operation: "write", Command: "dida official habit update <habit-id> --args-json '{...}' --json", HTTP: []string{"POST https://mcp.dida365.com tools/call update_habit"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment. Payload follows the official MCP tool schema."},
		{ID: "official.habit.checkin", Title: "Upsert a habit check-in through official MCP", Resource: "official-habit", Operation: "write", Command: "dida official habit checkin <habit-id> --date YYYY-MM-DD --value 1 --json", HTTP: []string{"POST https://mcp.dida365.com tools/call upsert_habit_checkins"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.habit.checkins", Title: "Read habit check-ins through official MCP", Resource: "official-habit", Operation: "read", Command: "dida official habit checkins --habit-ids <ids> --from YYYYMMDD --to YYYYMMDD --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_habit_checkins"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.focus.get", Title: "Read one focus record through official MCP", Resource: "official-focus", Operation: "read", Command: "dida official focus get <focus-id> --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_focus"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.focus.list", Title: "List focus records through official MCP", Resource: "official-focus", Operation: "read", Command: "dida official focus list --start-time RFC3339 --end-time RFC3339 --json", HTTP: []string{"POST https://mcp.dida365.com tools/call get_focuses_by_time"}, Status: "stable", AuthRequired: false, Notes: "Requires DIDA365_TOKEN in the environment."},
		{ID: "official.focus.delete", Title: "Delete focus record through official MCP", Resource: "official-focus", Operation: "delete", Command: "dida official focus delete <focus-id> --yes --json", HTTP: []string{"POST https://mcp.dida365.com tools/call delete_focus"}, Status: "stable", AuthRequired: false, ConfirmationRequired: true, Notes: "Requires DIDA365_TOKEN in the environment. Use only when the target focus record is known."},
		...
		{ID: "openapi.projectDelete", Title: "Delete project through official OpenAPI", Resource: "openapi-project", Operation: "delete", Command: "dida openapi project delete <project-id> --yes --json", HTTP: []string{"DELETE /open/v1/project/{projectId}"}, Status: "stable", AuthRequired: false, DryRun: true, ConfirmationRequired: true, Notes: "Requires an already saved OAuth access token. Preview with --dry-run first."},
		...
		{ID: "openapi.taskDelete", Title: "Delete task through official OpenAPI", Resource: "openapi-task", Operation: "delete", Command: "dida openapi task delete --project <project-id> --task <task-id> --yes --json", HTTP: []string{"DELETE /open/v1/project/{projectId}/task/{taskId}"}, Status: "stable", AuthRequired: false, DryRun: true, ConfirmationRequired: true, Notes: "Requires an already saved OAuth access token."},
		...
		{ID: "openapi.focusDelete", Title: "Delete focus record through official OpenAPI", Resource: "openapi-focus", Operation: "delete", Command: "dida openapi focus delete <focus-id> --type 0 --yes --json", HTTP: []string{"DELETE /open/v1/focus/{focusId}?type=0"}, Status: "stable", AuthRequired: false, DryRun: true, ConfirmationRequired: true, Notes: "Requires an already saved OAuth access token."},
