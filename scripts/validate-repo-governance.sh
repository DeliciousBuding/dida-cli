...
require_text .github/workflows/codeql.yml 'github/codeql-action/init@v[0-9]+' "CodeQL init action"
require_text .github/workflows/codeql.yml 'github/codeql-action/analyze@v[0-9]+' "CodeQL analyze action"
...
require_text .github/workflows/scorecard.yml 'ossf/scorecard-action@v[0-9]' "OpenSSF Scorecard action"
