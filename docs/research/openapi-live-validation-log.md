...
| Project endpoint family | implemented, not fully live-verified | `openapi project list/get/data/create/update/delete` exist; create/update/delete support local dry-run previews. | Run reads after token persistence succeeds; write smoke only with a disposable project. |
