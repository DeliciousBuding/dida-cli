...
| Release distribution | `.github/workflows/release.yml`, `install.sh`, `install.ps1`, release `v0.1.6` | Implemented and smoke-tested |
...
- Windows installer smoke passed against `v0.1.6`.
...
- Package manager templates exist for Homebrew and Scoop under `packaging/`,
  pinned to `v0.1.6` release assets and checksums.
