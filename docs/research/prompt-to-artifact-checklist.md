...
| Official MCP channel is explicit | `docs/research/official-mcp-tool-crosswalk.md`, `docs/research/official-mcp-vs-webapi.md` | done | Token-based health, tools, project data, task query, and focus list were live-smoked on 2026-05-10. |
| Official MCP high-value wrappers exist | `internal/cli/official_cmd.go`, `docs/research/official-mcp-wrapping-policy.md` | partial | First-class read wrappers are partly live-smoked; write wrappers still need disposable targets. |
