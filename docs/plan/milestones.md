...
| 4 | Provenance-ready release workflow | After Phase 4 | Changelog structure and npm package contracts are tested; release workflow supports Trusted Publishing/OIDC with `NPM_TOKEN` fallback | Complete |
