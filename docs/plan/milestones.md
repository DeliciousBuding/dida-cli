...
| 7 | Pinned workflow dependencies | After Phase 7 | External workflow actions are pinned to full SHAs; CI and release-check validate that pinned-actions contract | Active |
