...
| 8 | Release archive provenance | After Phase 8 | GitHub Release archives get artifact attestations; governance validation requires the release attestation action and permissions | Complete |
